   ...
   <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <a class="sidebar-brand d-flex align-items-center justify-content-center" href="d-venda.php">
            <div class="">
               <img class="img-fuid" src="./assets/img/logo-dashboard.png">
            </div>
         </a>
         <!-- Divider -->
         ...
         <div id="content">
            ...
            <form class="container" id="formCadastroProduto" name="formCadastroProduto" method="POST" action="./control/ctr-cadastro-produt.php">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nomeProduto" placeholder="Ex: Sabonete Líquido" name="inputName" required>
               </div>
               <div class="form-row">
                  <div class="form-group col-md-6 ">
                     <label for="dinheiro">Valor unitário</label>
                     <input type="text" id="dinheiro" name="valor" class="dinheiro form-control" placeholder="Ex: 20,50" required>
                  </div>
                  <div class="form-group col-md-6 ">
               ...
               <div class="col-auto">
                  <button type="submit" class="btn btn-primary mb-2" value="<?php echo $Acao; ?>">Cadastrar</button>
