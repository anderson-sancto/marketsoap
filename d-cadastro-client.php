            ...
            <form class="container" id="formCadastroClient" name="formCadastroClient" method="POST" action="./control/ctr-cadastro-client.php">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" name="telefone" class="telefone form-control" placeholder="Ex (71) 9 9173-3578" required>
                  </div>
               </div>
               <div class="form-row">
                  <div class="form-group col-md-6">
               ...
               <div class="form-row">
                  <div class="form-group col-md-6">
                     ...
                     <input type="text" class="form-control" id="inputAddress2" placeholder="Ex: Rua A , N 10 , Brotas" name="endereco" required>
                  </div>
                  <div class="form-group col-md-6">
