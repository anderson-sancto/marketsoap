            ...
            <div id="content">
               ...
               <div class="content">
                  ...
                  <div class="container">
                     <fieldset disabled>
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-5">
                              ...
                              <input type="text" class="form-control" id="inputLogin" placeholder="<?php echo $Fetch['email']; ?>">
                           </div>
                     ...
                     <a href="d-listar-client.php"> <button class="btn btn-primary">Voltar</button></a>
                  </div>
               </div>
            </div>
            <!-- Footer -->
