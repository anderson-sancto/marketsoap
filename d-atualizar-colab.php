                ...
                <form class="container" id="formCadastroColab" name="formCadastroColab" method="POST" action="./control/ctr-cadastro-colab.php">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="nascimento" class="dataNascimento form-control" placeholder="Ex: 1980/12/25" value="<?php echo $Nascimento; ?>" required />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" class="form-control" id="inputPassword4" placeholder="Senha" name="senha" value="<?php echo $Senha; ?>" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="cep" class="cep form-control" placeholder="Digite o CEP" value="<?php echo $Cep; ?>" required />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="telefone" id="telefone" class="telefone form-control" placeholder="Ex: (71) 9 9173-3578" value="<?php echo $Telefone; ?>" required />
                        </div>
                        <div class="form-group col-md-5">
                            <label for="inputJob">Função</label>
                            <input type="text" class="form-control" id="inputJob" name="funcao" value="<?php echo $Funcao; ?>" required>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary" href="d-atualizar-colab.html" value="<?php echo $Acao; ?>">Cancelar</button>
                </form>
                <!-- Footer -->
