...
if (isset($_GET['id'])) {
   $Acao = "Editar";
   $Crud = new classcrud();
   $BFetch = $Crud->selectDB("*", "funcionario", "where id=?", array($_GET['id']));
   ...
   <div id="wrapper">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <!-- Fim do jumbotron -->
            <!-- Conteudo principal do form -->
            <form class="container" id="formCadastroColab" name="formCadastroColab" method="POST" action="./control/ctr-cadastro-colab.php">
               <input type="hidden" id="Acao" name="Acao" value="<?php echo $Acao; ?>">
               <input type="hidden" id="Acao" name="id" value="<?php echo $Id; ?>">
               <div class="form-row">
                  <div class="form-group col-md-6">
                     <label for="inputName">Nome</label>
                     <input type="text" class="form-control" id="inputName" placeholder="Nome" name="inputName" required>
                  </div>
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" name="nascimento" class="dataNascimento form-control" placeholder="Ex: 1980/12/25" required />
                  </div>
               </div>
               <div class="form-row">
                  <div class="form-group col-md-6">
                     <label for="inputEmail4">Email / Login</label>
                     <input type="email" class="form-control" id="inputEmail4" placeholder="Insira endereço de E-mail" name="email" required>
                  </div>
                  <div class="form-group col-md-6">
                     <label for="inputPassword4">Senha</label>
                     <input type="password" class="form-control" id="inputPassword4" placeholder="Senha" name="senha" v required>
                  </div>
               </div>
               <div class="form-row">
                  <div class="form-group col-md-4">
                     <label for="inputAddress2">Endereço</label>
                     <input type="text" class="form-control" id="inputAddress2" placeholder="Ex: Rua A , N 10 , Brotas" name="endereco" v required>
                  </div>
                  <div class="form-group col-md-4">
                     <label for="inputCity">Cidade</label>
                     <input type="text" class="form-control" id="inputCity" placeholder="Ex: Salvador" name="cidade" required>
                  </div>
                  <div class="form-group col-md-2">
                     <label for="estado">Estado</label>
                     <select id="select" class="form-control" name="estado" required>
                        <option selected> Selecione</option>
                        <option>AC</option>
                        <option>AL</option>
                        <option>AP</option>
                  ...
                  <div class="form-group col-md-2">
                     ...
                     <input type="text" name="cep" class="cep form-control" placeholder="Digite o CEP" required />
                  </div>
               </div>
               <div class="form-row">
                  <div class="form-group col-md-4">
                     <label for="inputCpf">CPF</label>
                     <input type="text" name="cpf" class="cpf form-control" placeholder="Digite seu CPF" required />
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputPhone">Telefone</label>
                     <input type="text" name="telefone" id="telefone" class="telefone form-control" placeholder="Ex: (71) 9 9173-3578" required />
                  </div>
                  <div class="form-group col-md-5">
                     <label for="inputJob">Função</label>
                     <input type="text" class="form-control" id="inputJob" name="funcao" required>
                  </div>
               </div>
               ...
               <button type="submit" class="btn btn-primary" value="<?php echo $Acao; ?>">Cadastrar</button>
