          ...
          <div class="container">
            <fieldset disabled>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nomeProduto" placeholder="<?php echo $Fetch['nome']; ?>">
              </div>
              <div class="form-row">
                <div class="form-group col-md-6 ">
                  <label for="dinheiro">Valor unitário</label>
                  <input type="text" id="dinheiro" name="valor" class="dinheiro form-control" placeholder="<?php echo $Fetch['valor']; ?>">
                </div>
                <div class="form-group col-md-6 ">
                  <label for="dinheiro">Quantidade em estoque</label>
                  <input type="text" id="quantidade" name="quantidade" class="form-control" placeholder="<?php echo $Fetch['quantidade']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Descrição do produto</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="<?php echo $Fetch['descricao']; ?>" name="descricao"></textarea>
              </div>
            </fieldset>
            <a href="d-listar-produto.php"> <button class="btn btn-primary">Voltar</button></a>
          </div>
        </div>
      </div>
      <!-- Footer -->
